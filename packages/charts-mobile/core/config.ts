...
const G_COLORS = {
  ...
  grid: '#D8D8D8', // 网格颜色
  axis: '#BFBFBF', // 坐标轴颜色
  toolTipColor: '#FFFFFF', // tooltip文字颜色
  toolTipBackground: 'rgba(50, 50, 50, 0.8)', // tooltip背景色
...
const G_SETS = {
  ...
  fontTitle: 16, // 标题大小
  fontAxis: 12, // 坐标轴文字大小
  fontLegend: 12, // 图例文字大小
  fontTooltip: 12, // tooltip文字大小
