...
import type { MAChartsProps, EChartsInstance } from '../core/types';
...
class Chart extends PureComponent<ChartProps> {
   ...
   */
  public ele: HTMLDivElement | undefined | null;
  ...
  private async renderNewEcharts() {
    ...
    if (this.ele && autoResize) {
      ...
      if (!this.resizeObserver) {
        ...
        // (this.resizeObserver as any).observe?.(parentNode);
        (this.resizeObserver as any).observe?.(this.ele);
      }
    }
  }
